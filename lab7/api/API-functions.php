...
function addressSave($fname, $lname,
            $email,
            $phone,
            $address1,
            $address2,
    ...
    $response = false;
    $db = dbconnect();
    $stmt = $db->prepare("INSERT INTO contact SET fname = :fname, lname = :lname, email = :email, phone = :phone, address1 = :address1, address2 = :address2, city = :city, state = :state, zip = :zip");
